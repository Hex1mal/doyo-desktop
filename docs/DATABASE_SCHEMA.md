...
Doyo stores data in SQLite at the Tauri app data directory for `io.github.sembee.doyo`.

Typical Linux path:

```text
~/.local/share/io.github.sembee.doyo/doyo.db
```
...
```text
~/.local/share/io.github.sembee.doyo/backups/
```
